...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `grade1`(`Item_No`, `Item_Name`, `Qauntity`, `Price`) VALUES (NULL,'$Item_Name','$Qauntity','$Price')";
...
<html>
    ...
    <h1 class="mb-3" style="text-align:center"><b>Add New</b></h2>
    ...
    <div class="container d-flex justify-content-center">
        <form action="" method="post" style="width:50vw; min-width300px;">
            ...
            <div class="row">
                <div class="col">
                    <label class="form-label">Qauntity : </lable>
                    <input type="text" class="form-control" name="Qauntity">
            </div>  
