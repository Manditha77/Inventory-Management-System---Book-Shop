...
<head>
    ...
    <link rel="stylesheet" href="C:/Users/Dulmi/Desktop/Book_Shop_Project/Inventory-Management-System---Book-Shop/UI/login.css">
...
<body>
    ...
    <main class="dashboard-main">
        <header class="dashboard">
            <h1><i class="fa fa-bars"></i><span>DASHBOARD</span></h1>
        </header>
